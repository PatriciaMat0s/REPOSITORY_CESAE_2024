...
public class Oficina {
    ...
    public void imprimirStock() {
        ...
        // Imprimimos os elemtnos do stock acedidos através do get com os índices de interesse:
    ...
    public void comprarItem(Piloto piloto){
        ...
        if ( piloto.getFichasCorrida() >= itemCorrida.getPreco() ){
            ...
            System.out.println("BOOHOO, YOU DON'T HAVE ENOUGH RACE COINS TO ACQUIRE THE ITEM!");
